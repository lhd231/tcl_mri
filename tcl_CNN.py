...
def inference(x, list_hidden_nodes, num_class, wd = 1e-4, maxout_k = 2, MLP_trainable = True, feature_nonlinearity='abs'):
    ...
    in_dim = 1
    x = tf.reshape(x,[-1,x.get_shape().as_list()[1],1,1])
